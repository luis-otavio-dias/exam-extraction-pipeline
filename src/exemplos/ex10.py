...
- Identifique se há alguma imagem associada à questão e retorne um valor booleano indicando a presença de imagem.
- No campo "metodo", identifique que elementos te levaram a identificar o campo "imagem" como true ou false.
